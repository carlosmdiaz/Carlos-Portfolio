...
function Navbar() {
  ...
  useEffect(() => {
    if (
      router.asPath === "/projects/p1" ||
      router.asPath === "/projects/p2" ||
      router.asPath === "/projects/p3" ||
      router.asPath === "/projects/p4"
    ) {
  ...
  return (
    <div
      ...
      className={
        shadow
          ? "fixed w-full h-[90px] shadow-xl z-[100]"
          ...
          <div>
            ...
            <div className="border-b border-gray-300 my-4">
              <p className="w-[85%] md:w-[90%] py-2">
                Let<span>&#39;</span>s build something legendary together!
              </p>
            </div>
          </div>
